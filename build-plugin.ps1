...
param([ValidatePattern('^\d+\.\d+\.\d+\.\d+$')][string]$Version = "0.1.0.0")
...
$taskMeta = [ordered]@{
    category = "General"
    changelog = "Private v1 preview: safe replacement, original retention, identity registry. See README for verification limits."
