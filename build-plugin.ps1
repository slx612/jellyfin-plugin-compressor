...
param([ValidatePattern('^\d+\.\d+\.\d+\.\d+$')][string]$Version = "0.1.10.0")
...
$taskMeta = [ordered]@{
    category = "General"
    changelog = "Experimental preview: the resolution selector now shows the saved limit correctly after reopening the dashboard. Automatic compression stays off by default."
