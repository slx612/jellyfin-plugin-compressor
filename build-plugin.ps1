...
param([ValidatePattern('^\d+\.\d+\.\d+\.\d+$')][string]$Version = "0.1.9.0")
...
$taskMeta = [ordered]@{
    category = "General"
    changelog = "Experimental preview: the dashboard warns about unsaved folder changes and selected folders with no Jellyfin movies before analysis. Automatic compression stays off by default."
